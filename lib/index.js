...
exports.createSelect = exports.createReducer = exports.createReactionSet = exports.reactions = exports.createWrap = void 0;

const identity = value => value;

const defaultCreateReaction = type => payload => ({
  type,
  payload
});
...
const createReducer = initialStateOrInitFunction => (...args) => {
...
const createSelect = (getSubState = identity) => {
